...
class Solution(object):
    def firstMissingPositive(self, nums):
        ...
        while itocheck <= lastplace:
            #print itocheck, nums, lastplace
            x = nums[itocheck]
            if x > lastplace+1 or x < 1 or (x!=itocheck+1 and nums[x-1] == x):
                #print 'c1'
                tx = nums[lastplace]
                nums[lastplace] = x
                nums[itocheck] = tx
...
print sol.firstMissingPositive([1,2,3]), 4
print sol.firstMissingPositive([5,6,3,1,2,32]), 4
print sol.firstMissingPositive([5,6,3,1,2,3,4]), 7
print sol.firstMissingPositive([5,6,3,1,2,3,7,4]), 8
print sol.firstMissingPositive([5,6,3,1,2,7,4]), 8